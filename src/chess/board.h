...
public:
    bool in_check() const {
        return attack_lines_.as_int();
    }
    bool in_double_check() const {
        return double_check_;
    }
...
public:
    ...
    bool IsUnderCheck() const {
        return IsUnderAttack(our_king_);
    }
    ...
    public:
        ...
        void set_they_can_00() {
            data_ |= 4;
        }
        void set_they_can_000() {
            data_ |= 8;
        }

        void reset_we_can_00() {
            data_ &= ~1;
        }
        void reset_we_can_000() {
            data_ &= ~2;
        }
        void reset_they_can_00() {
            data_ &= ~4;
        }
        void reset_they_can_000() {
            data_ &= ~8;
        }

        bool we_can_00() const {
            return data_ & 1;
        }
        bool we_can_000() const {
            return data_ & 2;
        }
        bool they_can_00() const {
            return data_ & 4;
        }
        bool they_can_000() const {
            return data_ & 8;
        }
        bool no_legal_castle() const {
            return data_ == 0;
        }
        ...
        uint8_t queenside_rook() const {
            return queenside_rook_;
        }
        uint8_t kingside_rook() const {
            return kingside_rook_;
        }
    ...
    BitBoard theirs() const {
        return their_pieces_;
    }
    ...
    BitBoard bishops() const {
        return bishops_ - rooks_;
    }
    BitBoard rooks() const {
        return rooks_ - bishops_;
    }
    ...
    const Castlings& castlings() const {
        return castlings_;
    }
    bool flipped() const {
        return flipped_;
